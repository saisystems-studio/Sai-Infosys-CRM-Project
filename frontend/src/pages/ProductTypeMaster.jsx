...
export default function ProductTypeMaster({ permissions = {} }) {
  ...
  const handleSave = async () => {
    try {
      ...
      console.error(error);
      alert("Error while saving product type");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="master-header">
        <div className="header-content">
          <div>
            ...
            <p>Manage all product types used in CRM</p>
          </div>
          <div className="header-stats">
            <span className="stat-badge">Total: {productTypes.length}</span>
          </div>
        </div>
      </div>
